...
if isfile(['D:/interaction/inter/sub-' subject '/func/sub-' subject '_task-cpshop_run-01_bold.nii']) == 0
    display('Run 1 has not been unzipped; unzipping now')
    gunzip(['D:/interaction/inter/sub-' subject '/func/sub-' subject '_task-cpshop_run-01_bold.nii.gz'])
else
    display('Run 1 is already unzipped; doing nothing')
end

if isfile(['D:/interaction/inter/sub-' subject '/func/sub-' subject '_task-cpshop_run-02_bold.nii']) == 0
    display('Run 2 has not been unzipped; unzipping now')
    gunzip(['D:/interaction/inter/sub-' subject '/func/sub-' subject '_task-cpshop_run-02_bold.nii.gz'])
else
    display('Run 2 is already unzipped; doing nothing')
end

if isfile(['D:/interaction/inter/sub-' subject '/func/sub-' subject '_task-cpshop_run-03_bold.nii']) == 0
    display('Run 3 has not been unzipped; unzipping now')
    gunzip(['D:/interaction/inter/sub-' subject '/func/sub-' subject '_task-cpshop_run-03_bold.nii.gz'])
else
    display('Run 3 is already unzipped; doing nothing')
end

if isfile(['D:/interaction/inter/sub-' subject '/func/sub-' subject '_task-cpshop_run-04_bold.nii']) == 0
    display('Run 4 has not been unzipped; unzipping now')
    gunzip(['D:/interaction/inter/sub-' subject '/func/sub-' subject '_task-cpshop_run-04_bold.nii.gz'])
else
    display('Run 4 is already unzipped; doing nothing')
end

if isfile(['D:/interaction/inter/sub-' subject '/anat/sub-' subject '_T1w.nii']) == 0
    display('Anatomical image has not been unzipped; unzipping now')
    gunzip(['D:/interaction/inter/sub-' subject '/anat/sub-' subject '_T1w.nii.gz'])
else
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {
                                                                     {['D:\interaction\inter\sub-' subject '\func\sub-' subject '_task-cpshop_run-01_bold.nii']}
                                                                     {['D:\interaction\inter\sub-' subject '\func\sub-' subject '_task-cpshop_run-02_bold.nii']}
                                                                     {['D:\interaction\inter\sub-' subject '\func\sub-' subject '_task-cpshop_run-03_bold.nii']}
                                                                     {['D:\interaction\inter\sub-' subject '\func\sub-' subject '_task-cpshop_run-04_bold.nii']}  
                                                                     }';
...
matlabbatch{4}.spm.spatial.coreg.estwrite.source = {['D:/interaction/inter/sub-' subject '/anat/sub-' subject '_T1w.nii,1']};
...
matlabbatch{9}.spm.stats.fmri_spec.dir = {['D:/interaction/inter/sub-' subject '/1stLevel']};
...
%
data_together_run1 = load(['D:/interaction/inter/sub-' subject '/func/together_run1.txt']);
...
%%
data_alone_run1 = load(['D:/interaction/inter/sub-' subject '/func/alone_run1.txt']);
...
%%
data_together_run2 = load(['D:/interaction/inter/sub-' subject '/func/together_run2.txt']);
...
%%
data_alone_run2 = load(['D:/interaction/inter/sub-' subject '/func/alone_run2.txt']);
...
%%
data_together_run3 = load(['D:/interaction/inter/sub-' subject '/func/together_run3.txt']);
...
%%
data_alone_run3 = load(['D:/interaction/inter/sub-' subject '/func/alone_run3.txt']);
...
%%
data_together_run4 = load(['D:/interaction/inter/sub-' subject '/func/together_run4.txt']);
...
%%
data_alone_run4 = load(['D:/interaction/inter/sub-' subject '/func/alone_run4.txt']);
...
matlabbatch{11}.spm.stats.con.consess{1}.tcon.name = '1';
matlabbatch{11}.spm.stats.con.consess{1}.tcon.weights = [1 1 1 1 1 1 1 1];
